module smatrix_core_homogeneous_class
  use math
  use bessel
  ...
  type,public,extends(smatrix_core) :: smatrix_core_homogeneous
     ! real(8) :: w
     ! 外部のパラメータ
     complex(8) :: rho_ext
     complex(8) :: kappa_ext
   ...
   contains
     procedure :: del
     procedure :: new
  end type smatrix_core_homogeneous

  

contains
  elemental subroutine del(self)
    class(smatrix_core_homogeneous),intent(inout) :: self
...
end module smatrix_core_homogeneous_class
